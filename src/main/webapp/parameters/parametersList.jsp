...
<html>
  <head>
	...
	function add(){
		$.post("parameters/toadd.do",{},function(data){
			//$("#objdiv").show();
	...
	function toPage(p){
		...
		if(p<=0||p>total){
  		...
  		document.frm.action="parameters/list.do";
    	...
    	<table width="100%" class="table-ellipsis">
          <tr class="back_tit">
            <td style="width:5%;">编号</td>
             <td style="width:5%;">登录名称</td>
            <td style="width:10%;">登录密码</td>
         ...
         <tr class="hang01">
		    ...
		    <input type="button" class="gaic" value="删除" onclick="window.location.href='<%=path %>/parameters/delete.do?Id=${o.uid }'">
		    </td>
		    </tr>
		    </c:forEach>
        </table><br>
