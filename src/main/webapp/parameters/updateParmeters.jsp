...
<html>
  ...
  <form action="parmeters/update.do" method="post">
	...
	<table class="tck" width="213" border="0" cellspacing="0" cellpadding="0">
		...
		<input class="text_yhm" name="casename" value="${data.loginname}" onblur="checkdulname(this.value)" maxlength="32"/><span id="checkname_error"></span>
		</td></tr>
		<tr bgcolor=white><td class="tc_w108" align=right>用户密码：</td><td>
			&nbsp;&nbsp;<textarea name="url" style="width:220px;">${data.loginpass}</textarea>
		</td></tr>
